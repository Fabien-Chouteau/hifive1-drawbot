...
package body Gcode.Planner is
   ...
   procedure Planner_Task_Body (Motion : Motion_Block);
...
--     end Get_Next_Segment;
   ...
   procedure Planner_Task_Body (Motion : Motion_Block) is
--        Motion               : Motion_Block;
      Seg                  : Segment;
...
--           Motion_Block_Buffer.Remove (Motion);
      ...
      case Motion.Kind is
         ...
         when Motion_Homing =>
            ...
            --  Blocking call
            Execute_Segment ((Kind => Homing_Segment));

         when Motion_Enable_Motors =>
            Execute_Segment
              ((Kind => Enable_Motors_Segment,
