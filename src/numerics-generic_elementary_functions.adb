...
with Numerics.Long_Elementary_Functions;
with Numerics.Long_Long_Elementary_Functions;

use Numerics.Elementary_Functions;
use Numerics.Long_Elementary_Functions;
use Numerics.Long_Long_Elementary_Functions;

package body Numerics.Generic_Elementary_Functions is
...
end Numerics.Generic_Elementary_Functions;
