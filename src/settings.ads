...
package Settings is
   ...
   Step_Per_Millimeter : constant Gcode.Float_Position := (X_Axis => 80.0,
                                                           Y_Axis => 38.0,
                                                           Z_Axis => 1.0);
   ...
   Direction_Pulse_Delay_Ms : constant := 1;
   --  Minimum delay between direction pin change and step pulse

   Step_Pulse_Duration_Ms : constant := 1;
   ...
   --  Buffers sizes
   Block_Buffer_Size   : constant := 50;
   Segment_Buffer_Size : constant := 50;
end Settings;
